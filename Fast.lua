...
{
{text = '✭ سورس المتهور ✭', url = 'https://t.me/ziro_k6 '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/ziro_k8 '},
},
}
...
video = "https://t.me/ziro_k6/95"
local T = "*✭ مـرحـبا انـا صـانـع بـوتـات\n✭ اقوم بصنع بوتات حمايه\n✭ تم برمجتي من قبل المطور متهور\n✭ للتنصيب الحمايه ارسل /caesar\n✭ او اتبع الازرار بالاسفل*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✭ المبرمج متهور ✭', url = 't.me/ziro_k8 '},
},
{  
{text = '✭ سورس المتهور ✭', url = 't.me/ziro_k6 '},
},
}
local msgg = msg.id/2097152/0.5
...
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 عرين المتهور](t.me/ziro_k6 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/ziro_k8 '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/ziro_k8'},
},
{
{text = '• قناة التحديثات •', url = 't.me/ziro_k6 '},
},
{  
{text = '• 𝐒𝐎𝐔𝐑𝐂𝐄 عرين المتهور •', url = 't.me/ziro_k6 '},
},
}
local msgg = msg.id/2097152/0.5
